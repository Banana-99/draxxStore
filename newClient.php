...
if (isset($_POST['nom'])) {
  var_dump($_POST);
  $clients->addClient($_POST['nom'], $_POST['prenom'], $_POST['email'], $_POST['adresse'], $_POST['telephone'], $_POST['type']);
  // head to the client page
        ...
        <div class="card z-index-0">
            ...
            <div class="card-body">
                <form method="post" role="form text-left">
                    <div class="mb-3">
                        <input required name="nom" type="text" class="form-control" placeholder="Name" aria-label="Nom"
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">
                            Creer un client <i class="fa-plus-circle"></i>
                        </button>
                    </div>
                </form>
            </div>
